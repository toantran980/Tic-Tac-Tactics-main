...
class NPC():
    ...
    def draw_dialogue_box(self):
        ...
        box_y = screen.get_height() - box_height - 20  # 20 pixels from the bottom

        # Draw the box
        pygame.draw.rect(screen, (0, 0, 0), (box_x, box_y, box_width, box_height))  # Black box
        pygame.draw.rect(screen, (255, 255, 255), (box_x + 5, box_y + 5, box_width - 10, box_height - 10))  # White inner box
